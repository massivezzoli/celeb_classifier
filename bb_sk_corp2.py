...
trained_dir_2 = "/mnt/data/corpi/gaussian_masked_20_50/"
...
model_path = os.path.join(model_dir, 'model_150.h5')
...
try:
    model.fit([imgs_train, bots_train], lab_train_ohe,
              batch_size=50, epochs=70, verbose=1,
    ...
    file_name = 'model2_'+str(epc_count)+'.h5'
